...
const NAV = [
  ...
  { href: '/rentals',   label: 'My Rentals', icon: FileText  },
]
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-14">
          ...
          >
            ...
            <span className="text-[10px] font-bold px-1.5 py-0.5 rounded bg-forest/15 text-forest select-none">
              BD
            </span>
          </Link>

          {/* Desktop nav */}
          <nav className="hidden md:flex items-center gap-0.5" aria-label="Customer navigation">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative" ref={dropRef}>
              ...
              >
                <span className="w-7 h-7 rounded-full bg-forest/15 text-forest text-xs font-bold flex items-center justify-center select-none">
                  {initials}
                </span>
        ...
        <div className="md:hidden border-t border-ink-100 bg-white px-4 py-3 space-y-1">
          ...
          <div className="pt-2 border-t border-ink-100">
            <Link
              href="/customer/settings"
              onClick={() => setMobileOpen(false)}
              className="flex items-center gap-2 px-3 py-2.5 text-sm font-medium text-ink-700 hover:bg-ink-50 rounded-xl transition"
            >
              <Settings size={16} />
              Account settings
            </Link>
